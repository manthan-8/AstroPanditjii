...
const Services: React.FC = () => {
 ...
 const zodiacSigns = t('zodiacSigns', { returnObjects: true }) as { key: string; label: string }[];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-br from-orange-100 to-yellow-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">{t('servicesP.horoscopeTitle', 'Daily Horoscope')}</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              {t('servicesP.horoscopeDescription', 'Get personalized predictions based on your zodiac sign for daily, weekly, and monthly guidance.')}
            </p>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-8">
                <h3 className="text-xl font-semibold text-gray-800 mb-4 text-center">{t('servicesP.selectZodiac', 'Select Your Zodiac Sign')}</h3>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h3 className="text-2xl font-bold text-gray-800 mb-4 text-center">
                  {selectedZodiacSign} - {t(`servicesP.${activeHoroscopeTab}`, activeHoroscopeTab.charAt(0).toUpperCase() + activeHoroscopeTab.slice(1))} {t('servicesP.horoscope', 'Horoscope')}
                </h3>
                <p className="text-gray-600 leading-relaxed text-center text-lg">
                  ...
                  t('servicesP.noHoroscope', 'Horoscope data will be updated soon. Please check back later.')}
                </p>
              </div>
            </div>
        </div>
      ...
      <section className="py-20 bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              {t('servicesP.muhuratDescription', 'Find the most favorable times for important life events and ceremonies based on Vedic calculations.')}
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-orange-100 to-yellow-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              {t('servicesP.remediesDescription', 'Simple yet powerful remedies to overcome life challenges and enhance positive planetary influences.')}
            </p>
          </div>
            ...
            {remedies.map((remedy, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="space-y-3">
                  <div>
                    <span className="font-semibold text-orange-600">{t('servicesP.remedy', 'Remedy')}: </span>
