          ...
          >
            <div className="flex gap-6 px-4">
              {services.slice(0, 6).map((service) => {
                let path = "/book/"; // default path
                if (service.title === "Kundali Making") path = "/kundali-making";
                else if (service.title === "Kundali Matching") path = "/kundali-matching";

                return (
                  <Link to={path} key={service.id} className="flex-shrink-0">
                    <div
